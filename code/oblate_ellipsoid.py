...
def tf(xp, yp, zp, ellipsoids, F, inc, dec, demag=True, pmag=None):
    ...
    * ellipsoids : list of :class:`fatiando.mesher.OblateEllipsoid`
...
def bx(xp, yp, zp, ellipsoids, F, inc, dec, demag=True, pmag=None):
    r"""
    The x component of the magnetic induction produced by oblate
    ellipsoids.
...
def by(xp, yp, zp, ellipsoids, F, inc, dec, demag=True, pmag=None):
    r"""
    The y component of the magnetic induction produced by oblate
    ellipsoids.
...
def bz(xp, yp, zp, ellipsoids, F, inc, dec, demag=True, pmag=None):
    r"""
    The z component of the magnetic induction produced by oblate
    ellipsoids.
...
def _bx(xp, yp, zp, ellipsoid, F, inc, dec, demag=True, pmag=None):
    ...
    * xp, yp, zp : arrays
        The x, y, and z coordinates where the anomaly will be calculated
    * ellipsoid : element of :class:`fatiando.mesher.OblateEllipsoid`.
...
def _lamb(x1, x2, x3, ellipsoid):
    '''
    Calculates the parameter lambda for a oblate ellipsoid.

    The parameter lambda is defined as the largest root of
    the quadratic equation defining the surface of the oblate
    ellipsoid.
...
def demag_factors(ellipsoid):
    ...
    * n11, n22: floats
        ...
        large and small axes of the oblate ellipsoid.
    '''
