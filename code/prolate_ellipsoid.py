...
due.cite(Doi("XXXXXXXXXXXXXXXXX"),
         description='Forward modeling formula for prolate ellipsoids.',
         path='fatiando.gravmag.prolate_ellipsoid')
...
def tf(xp, yp, zp, ellipsoids, F, inc, dec, pmag=None):
    ...
    * ellipsoids : list of :class:`fatiando.mesher.EllipsoidProlate`
...
def bx(xp, yp, zp, ellipsoids, F, inc, dec, pmag=None):
    r"""
    The x component of the magnetoc induction produced by prolate
...
def by(xp, yp, zp, ellipsoids, F, inc, dec, pmag=None):
    r"""
    The y component of the magnetoc induction produced by prolate
    ellipsoids (Emerson et al., 1985).
...
def bz(xp, yp, zp, ellipsoids, F, inc, dec, pmag=None):
    r"""
    The z component of the magnetoc induction produced by prolate
    ellipsoids (Emerson et al., 1985).
...
def _bx(xp, yp, zp, ellipsoid, F, inc, dec, pmag=None):
    ...
    * xp, yp, zp : arrays
        The x, y, and z coordinates where the anomaly will be calculated
    * ellipsoid : element of :class:`fatiando.mesher.EllipsoidProlate`
...
def magnetization(n11, n22, suscep, F, inc, dec, RM, incrm, decrm, matrix):
    ...
    assert n11 <= n22, 'n11 must be smaller than n22'
