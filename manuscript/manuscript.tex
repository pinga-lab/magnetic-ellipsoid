...
magnetized ellipsoids. Software packages that includes the 
ellipsoid model exist, but all very expensive.
...
consider an ellipsoid which is immersed in a uniform inducing
