...
can be found at the folder \textit{code} of the repository
\url{https://github.com/pinga-lab/magnetic-ellipsoid}.
...
The code used for generating the results presented in this section
can found at \url{https://github.com/pinga-lab/magnetic-ellipsoid/code}
