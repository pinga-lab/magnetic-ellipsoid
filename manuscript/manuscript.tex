...
(i.e., $a > b = c$), these unit vectors may be given by \citep{clark1986}:
\begin{equation}
...
\end{equation}
\citet{emerson1985} also calculate the unit vectors $\mathbf{v}_{1}$, $\mathbf{v}_{2}$,
and $\mathbf{v}_{3}$ by using Eqs. \ref{eq:v1_triaxial_prolate},
...
for oblate ellipsoids (i.e., $a < b = c$) may be calculated as follows:
\begin{equation}
\mathbf{v}_{1} = \left[\begin{array}{c} 
