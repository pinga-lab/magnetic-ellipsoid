...
(i.e., $a > b = c$), we opted for defining these unit vectors 
by following \citet{clark1986}:
\begin{equation}
...
\end{equation}
\citet{emerson1985} calculated the unit vectors $\mathbf{v}_{1}$, $\mathbf{v}_{2}$,
...
and $\mathbf{v}_{3}$ for oblate ellipsoids (i.e., $a < b = c$) as follows:
\begin{equation}
\mathbf{v}_{1} = \left[\begin{array}{c} 
...
\label{eq:v3_oblate}
\end{equation}
This approach is very similar to that presented by \citet{emerson1985}.
