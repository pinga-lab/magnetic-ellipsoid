...
field.
Besides, the geoscientific community lacks an free easy-to-use
tool to simulate the magnetic field produced by uniformly
magnetized ellipsoids. There are some commercial software
packages that includes the ellipsoid model, but all very
expensive.
