...
The total-field anomaly varies from $\approx -176$ \unit{nT}
to $\approx 237$ \unit{nT}, resulting in a peak-to-peak amplitude
of $\approx 413$ \unit{nT}, and was calculated by using the 
...
The peak-to-peak amplitude is $\approx 141$ \unit{nT}
and represents $\approx 34 \%$ of the peak-to-peak amplitude of
...
$\| \delta \mathbf{M} \| \, \| \mathbf{M} \|^{-1} \approx 2.4 \%$
...
(Fig. \ref{fig:tfa-differences-warrego}b) is $\approx 0.8$ \unit{nT},
which represents $\approx 2.9 \%$ of the peak-to-peak amplitude of the
...
$\| \delta \mathbf{M} \| \, \| \mathbf{M} \|^{-1} \approx 2.8 \%$
(Eq. \ref{eq:perturbed-M-inequality}) in the magnetization.
The peak-to-peak amplitude of the differences in the total-field anomaly
(Fig. \ref{fig:tfa-differences-warrego}c) is $\approx 1.1$ \unit{nT},
which represents $\approx 3.3 \%$ of the peak-to-peak amplitude of the
total-field anomaly calculates by using the true magnetization $\mathbf{M}$
(Eqs. \ref{eq:M-K-isotropic} and \ref{eq:M-K-isotropic-inverse-Lambda}).
